...
import com.ym.materials.serializer.impl.*;
...
public class SerializerEngine {
    ...
    public <T> byte[] serialize(T obj, String type) throws Exception {
    ...
    public <T> T deserialize(byte[] bytes, Class<T> clazz, String type) throws Exception {
        SerializeType serializeType = SerializeType.getSerializeType(type);
        if (type == null) {
            throw new RuntimeException("type in invalid");
        }
